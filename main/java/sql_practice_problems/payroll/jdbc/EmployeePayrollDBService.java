...
public class EmployeePayrollDBService {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/payroll_service?allowPublicKeyRetrieval=true&useSSL=false";
    private static final String USER = "root"; // change if needed
    private static final String PASSWORD = "mysql123"; // replace with your password
