...
mysql> INSERT INTO employee (id, name, gender, start_date, dept_id)
    -> VALUES
    -> (1, 'Vanshika', 'F', '2025-06-15'),
    -> (2, 'Harshita', 'F', '2025-07-13');
ERROR 1136 (21S01): Column count doesn't match value count at row 1
mysql> INSERT INTO employee (id, name, gender, start_date, dept_id)
    -> VALUES
    -> (1, 'Vanshika', 'F', '2025-06-15', 1),
    -> (2, 'Harshita', 'F', '2025-07-13', 2);
...
+----+----------+--------+------------+----------+-----------+----------+
|  1 | Vanshika | F      | 2025-06-15 | 90000.00 |  80000.00 | 75000.00 |
|  2 | Harshita | F      | 2025-07-13 | 70000.00 |  60000.00 | 55000.00 |
+----+----------+--------+------------+----------+-----------+----------+
2 rows in set (0.01 sec)

mysql> SELECT p.salary FROM employee e
    -> JOIN payroll p ON e.id = p.employee_id
    -> WHERE e.name = 'Harshita';
+----------+
| salary   |
+----------+
| 70000.00 |
...
+--------+--------------+--------------+------------+------------+----------------+
| F      |    160000.00 | 80000.000000 |   70000.00 |   90000.00 |              2 |
+--------+--------------+--------------+------------+------------+----------------+
